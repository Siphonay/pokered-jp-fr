...
; entries correspond to TRADE_FOR_* constants
	...
	npctrade ABRA,       MR_MIME,   TRADE_DIALOGSET_CASUAL,    "BARRY"
	npctrade BUTTERFREE, BEEDRILL,  TRADE_DIALOGSET_HAPPY,     "CHIKUCHIKU" ; unused
	npctrade PONYTA,     SEEL,      TRADE_DIALOGSET_CASUAL,    "BIBI"
	npctrade SPEAROW,    FARFETCHD, TRADE_DIALOGSET_POLITE,    "DONATIEN"
	npctrade SLOWBRO,    LICKITUNG, TRADE_DIALOGSET_POLITE,    "GLAVIOTEUR"
	npctrade POLIWHIRL,  JYNX,      TRADE_DIALOGSET_POLITE,    "NINI"
	npctrade RAICHU,     ELECTRODE, TRADE_DIALOGSET_POLITE,    "KOURJUS"
	npctrade VENONAT,    TANGELA,   TRADE_DIALOGSET_HAPPY,     "BIGOUDI"
	npctrade NIDORAN_F,  NIDORAN_M, TRADE_DIALOGSET_HAPPY,     "CHAPPY"
